...
//
//    if (!test) {
//        model_.vertex_buffer_.Create(vertices, sizeof(vertices));
//        model_.color_buffer_.Create(cores, sizeof(cores));
//        model_.index_buffer_.Create(indices, sizeof(indices) / sizeof(GLuint));
//    }
//    else {
//        model_.vertex_buffer_.Create(vertexes.data(), vertexes.size() * sizeof(vec3));
//        model_.color_buffer_.Create(colors.data(), colors.size() * sizeof(vec3));
//        model_.index_buffer_.Create(vertexIndices.data(), static_cast<unsigned int>(vertexIndices.size()));
//    }
//
